      ...
      // Initializing the object with required parameters
        ...
        // Validating the options
            ...
            this.options.duration =
                options.duration === 0 ? 0 : options.duration || Toastify.defaults.duration; // Display duration
            ...
            this.options.gravity =
                options.gravity === 'bottom' ? 'toastify-bottom' : Toastify.defaults.gravity; // toast position - top or bottom
            ...
            this.options.style.background =
                Toastify.defaults.backgroundColor || options.backgroundColor;
      ...
      // Building the DOM element
        ...
        // Adding a close icon to the toast
          ...
          // Adding the close icon to the toast element
                ...
                if (
                    (this.options.position == 'left' || this.options.positionLeft === true) &&
                    width > 360
                ) {
                    // Adding close icon on the left of content
...
;
        ...
        if (typeof this.options.onClick === 'function' && typeof this.options.destination === 'undefined') {
          ...
          let x = getAxisOffsetAValue('x', this.options);
                var y = getAxisOffsetAValue('y', this.options);

          let xOffset = this.options.position == 'left' ? x : '-' + x;
